...
class sick_nav350: public rclcpp::Node
{
    ...
    private:
        void init_param()
        {
            ...
            //this->get_parameter_or<std::string>("scan_frame_id", scan_frame_id, "nav350");
            ...
            //this->get_parameter_or<std::string>("target_frame_id",target_frame_id,"nav350");
                   ...
                   /////////////////////////////////////////////////////msgs from customized
        {
            ...
            scan_count++;
             ...
             RCLCPP_INFO(this->get_logger(),"here 3-1 ");
            ...
            RCLCPP_INFO(this->get_logger(),"here 3-2 ");
            ...
            for (size_t i = 0; i < n_intensity_values; i++) 
            {
              ...
              RCLCPP_INFO(this->get_logger(),"here 3-3 ");
            pub->publish(*scan_msg);
              RCLCPP_INFO(this->get_logger(),"here 3-4 ");
            /////////////////////////////////////////////////////msgs from customized
    ...
    public:    
        int work_loop()
        {
            ...
            try
            {
                ...
                while (rclcpp::ok())
                {
                  RCLCPP_INFO(this->get_logger(),"while command start");
