...
namespace SickToolbox {
  ...
  protected:
    ...
    void _startListening( ) noexcept(false); /*throw( SickThreadException );*/

    /** Stops the driver from listening */
    void _stopListening( )  noexcept(false); /*throw( SickThreadException );*/
    ...
    void _setBlockingIO( ) const noexcept(false); /*throw ( SickIOException );*/
    
    /** Make the associated file descriptor non blocking */
    void _setNonBlockingIO( ) const noexcept(false); /*throw ( SickIOException );*/
    ...
    void _sendMessage( const SICK_MSG_CLASS &sick_message, const unsigned int byte_interval ) const
      noexcept(false); /*throw ( SickIOException );*/

    /** Acquire the next message from the message container */
    void _recvMessage( SICK_MSG_CLASS &sick_message, const unsigned int timeout_value ) const noexcept(false); /*throw ( SickTimeoutException );*/
    ...
    void _recvMessage( SICK_MSG_CLASS &sick_message,
		       ...
		       const unsigned int timeout_value ) const noexcept(false); /*throw ( SickTimeoutException );*/
    ...
    virtual void _sendMessageAndGetReply( const SICK_MSG_CLASS &send_message,
					  ...
					  const unsigned int num_tries ) noexcept(false); /*throw( SickTimeoutException, SickIOException);*/ 
   ...
   */
  template< class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickLIDAR< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::_startListening( ) noexcept(false) /*throw( SickThreadException*/  {
   ...
   */
  template< class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickLIDAR< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::_stopListening( ) noexcept(false) /*throw( SickThreadException*/  {
   ...
   */
  template< class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickLIDAR< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::_setBlockingIO( ) const noexcept(false) /*throw( SickThreadException*/  {
   ...
   */
  template< class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickLIDAR< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::_setNonBlockingIO( ) const noexcept(false)/*throw ( SickIOException )*/ {
  ...
  void SickLIDAR< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::_sendMessageAndGetReply( const SICK_MSG_CLASS &send_message,
										 ...
										 noexcept(false) /*throw( SickTimeoutException, SickIOException )*/ {
