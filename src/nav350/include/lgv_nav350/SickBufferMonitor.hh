...
namespace SickToolbox {
  ...
  public:
    ...
    SickBufferMonitor( SICK_MONITOR_CLASS * const monitor_instance ) noexcept(false)/*throw( SickThreadException )*/;

    /** A method for setting the target data stream */
    void SetDataStream( const unsigned int sick_fd ) noexcept(false)/*throw( SickThreadException )*/;
    
    /** Start the buffer monitor for the device */
    void StartMonitor( const unsigned int sick_fd ) noexcept(false)/*throw( SickThreadException )*/;

    /** Acquire the most recent message buffered by the monitor */
    bool GetNextMessageFromMonitor( SICK_MSG_CLASS &sick_message ) noexcept(false)/*throw( SickThreadException )*/;
    
    /** Stop the buffer monitor for the device */
    void StopMonitor( ) noexcept(false)/*throw( SickThreadException )*/;

    /** Locks access to the data stream */
    void AcquireDataStream( ) noexcept(false)/*throw( SickThreadException )*/;
    ...
    void ReleaseDataStream( ) noexcept(false)/*throw( SickThreadException )*/;

    /** A standard destructor */
    ~SickBufferMonitor( ) noexcept(false)/*throw( SickThreadException )*/;
  ...
  private:
    ...
    void _acquireMessageContainer( ) noexcept(false)/*throw( SickThreadException )*/;

    /** Unlocks access to the message container */
    void _releaseMessageContainer( ) noexcept(false)/*throw( SickThreadException )*/;
   ...
   */
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::SickBufferMonitor( SICK_MONITOR_CLASS * const monitor_instance ) noexcept(false)/*throw( SickThreadException )*/
   ...
   */
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::SetDataStream( const unsigned int sick_fd ) noexcept(false)/*throw( SickThreadException )*/ {
   ...
   */
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::StartMonitor( const unsigned int sick_fd ) noexcept(false)/*throw( SickThreadException )*/ {
   ...
   */
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  bool SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::GetNextMessageFromMonitor( SICK_MSG_CLASS &sick_message ) noexcept(false)/*throw( SickThreadException )*/ {
   ...
   */
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::StopMonitor( ) noexcept(false)/*throw( SickThreadException )*/ {
   ...
   */ 
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::AcquireDataStream( ) noexcept(false)/*throw( SickThreadException )*/ {
   ...
   */ 
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::ReleaseDataStream( ) noexcept(false)/*throw( SickThreadException )*/ {
   ...
   */
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::~SickBufferMonitor( ) noexcept(false)/*throw( SickThreadException )*/ {
   ...
   */
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::_acquireMessageContainer( ) noexcept(false)/*throw( SickThreadException )*/ {
   ...
   */
  template < class SICK_MONITOR_CLASS, class SICK_MSG_CLASS >
  void SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::_releaseMessageContainer( ) noexcept(false)/*throw( SickThreadException )*/ {
  ...
  void SickBufferMonitor< SICK_MONITOR_CLASS, SICK_MSG_CLASS >::_readBytes( uint8_t * const dest_buffer, const int num_bytes_to_read, const unsigned int timeout_value ) const
    noexcept(false)/*throw( SickThreadException )*/ {
