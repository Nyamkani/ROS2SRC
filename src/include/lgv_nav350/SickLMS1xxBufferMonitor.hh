...
namespace SickToolbox {
  ...
  public:
    ...
    void GetNextMessageFromDataStream( SickLMS1xxMessage &sick_message ) noexcept(false) /*throw( SickIOException )*/;
  ...
  private:
    ...
    void _flushTCPRecvBuffer( ) const noexcept(false); /*throw ( SickIOException )*/
